...
| :--- | :--- | :--- | :--- |
| SB-AES-001 | AES Battery 35.2V | v1.1 | 2026-03-21 |
...
### Document overview:
> [!NOTE]
>- The purpose of this document is to serve as a troubleshooting guide for intermittent power loss in AES battery systems.
>
...
| <img src="../images/eyes.png" width="50"> | Sparks or flying debris may cause eye injury or blindness. |
...
3. **Battery Voltage Verification**
   ...
   - **Action:** 
     ...
     - If the SoC is not full, charge the battery to 100% before retesting.
...
```mermaid
flowchart TD
    A[Isolation] --> B{Visual Check}
   
    B --"Fault"--> Dispose
    B -- "OK" --> C{Voltage Check}

    C -- "Not full" --> E[Charge]
    E --"Fault"--> Dispose
    E -- "OK" --> F[Plug Check]

    C -- "In range" --> F[Plug Check]

    F --> I[Tug Test]
    
    I --> K[Validation Drive]
...
> <img src="../images/WEEE.png" width="50"> E-bike batteries and electronic parts are **ELECTRICAL WASTE**. Do not throw **faulty batteries** or replaced **electronic components** in the black bin. Bring electronic waste to a specialized recycling center or contact the distributor for WEEE take-back.
